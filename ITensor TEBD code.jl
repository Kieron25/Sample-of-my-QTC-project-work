...
#= The code was inspired by sample code which can be found here:
https://itensor.github.io/ITensors.jl/stable/tutorials/MPSTimeEvolution.html

This code is the same as the sample code, yet doesn't run due to how apply is
defined. So I think the sample code is out of date...

30/10/2021 - Correction: The code now works...
=#
